...
if (plotOutput == 'true'):
    ...
    temperaturePlotting = numpy.hstack([tempLeft, numpy.copy(Tvector),
                                       tempRight])
    ...
    temperatureAnalytical = (tempLeft + ((tempRight - tempLeft) *
                             ...
                             (heatSourcePerVol/(2.0*cond)) *
                             xAnalytical *
                             (barLength*numpy.ones(len(xAnalytical))
                             - xAnalytical))
    ...
    ax.plot(xPlotting, temperaturePlotting, 'o',
